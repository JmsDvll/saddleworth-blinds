  ...
  const areaHeroImages = [
    {
      ...
      alt: 'Beautiful window blinds in a Lees home',
      title: 'Lees Style',
      description: 'Elegant blinds for village homes'
    },
    {
      src: 'vision-firenze-walnut-1600.jpg',
      alt: 'Premium blinds showcasing natural wood tones in Lees',
      title: 'Natural Wood',
      description: 'Warm tones for traditional homes'
    },
    {
      src: 'roller-zen-kiwi-1600.jpg',
      alt: 'Modern roller blinds adding vibrant color to Lees interiors',
      title: 'Contemporary',
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-3 gap-6 pt-8">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium">Local Lees Experts</p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-brand-gold rounded-full flex items-center justify-center mx-auto mb-3">
                    <svg className="w-6 h-6 text-gray-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-gray-800 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-300">
                Perfect blinds for Lees's characteristic family homes, enhancing the community charm while providing modern functionality.
              </p>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-300">
                Blinds designed for Lees's modern family homes, combining style with practical functionality for busy households.
              </p>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-300">
                Trusted by Lees homeowners for over two decades. We know the local area and understand what works best for your home.
              </p>
            </div>
          </div>
