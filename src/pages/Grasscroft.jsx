          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Window Blinds in
                <span className="text-brand-gold block">Grasscroft</span>
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed">
                Beautiful window blinds for Grasscroft homes. From traditional stone cottages to modern family homes, we understand what works best in this charming Saddleworth village.
              </p>
      ...
      <div className="container py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">Blinds for Grasscroft Homes</h2>
            <p className="text-xl text-gray-300 leading-relaxed">
              Grasscroft offers a perfect blend of rural tranquility and modern living. We've been serving Grasscroft homeowners for over 20 years, understanding the unique character of this Saddleworth village and recommending the perfect blinds for both traditional and contemporary homes.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-gray-800 rounded-lg p-6 text-center">
              ...
              <h3 className="text-xl font-semibold mb-4">Traditional Stone Homes</h3>
              <p className="text-gray-300">
                Perfect blinds for Grasscroft's characteristic stone-built homes, enhancing the rustic charm while providing modern functionality.
              </p>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6 text-center">
              ...
              <p className="text-gray-300">
                Blinds designed for Grasscroft's modern family homes, combining style with practical functionality for busy households.
              </p>
            </div>
          ...
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-6">Ready to Transform Your Grasscroft Home?</h2>
            <p className="text-xl text-gray-300 mb-8">
              Join hundreds of satisfied Grasscroft customers who've trusted us with their window treatments. Let's discuss how we can enhance your home.
            </p>
