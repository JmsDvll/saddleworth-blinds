          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <h1 className="text-4xl lg:text-6xl font-bold leading-tight">
                Window Blinds in
                <span className="text-brand-gold block">Grotton</span>
              </h1>
              <p className="text-xl text-gray-300 leading-relaxed">
                Beautiful window blinds for Grotton homes. From traditional family homes to modern properties, we understand what works best in this welcoming Saddleworth village.
              </p>
      ...
      <div className="container py-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">Blinds for Grotton Homes</h2>
            <p className="text-xl text-gray-300 leading-relaxed">
              Grotton offers a perfect blend of community spirit and modern living. We've been serving Grotton homeowners for over 20 years, understanding the unique character of this Saddleworth village and recommending the perfect blinds for both traditional and contemporary homes.
            </p>
          </div>
          ...
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-6">Ready to Transform Your Grotton Home?</h2>
            <p className="text-xl text-gray-300 mb-8">
              Join hundreds of satisfied Grotton customers who've trusted us with their window treatments. Let's discuss how we can enhance your home.
            </p>
