                ...
                <GlowBox key={index} variant="subtle" intensity="low">
                  <Card variant="elevated" hover="lift" padding="large">
                    <Stack spacing="medium" align="center">
                      ...
                      <Link
                        href={method.action.includes('@') || method.action.includes('tel:') ? method.action : undefined}
                        to={!method.action.includes('@') && !method.action.includes('tel:') ? method.action : undefined}
                        variant="button"
                        size="small"
                      >
                        {method.actionText}
