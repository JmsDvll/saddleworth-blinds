...
const iconPaths = {
  ...
  palette: 'M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c1.19 0 2.34-.21 3.41-.6.3-.11.49-.4.49-.72 0-.43-.35-.78-.78-.78-.17 0-.33.06-.46.14-.83.32-1.73.49-2.66.49-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8c0 .29-.02.58-.05.86-.02.12-.03.24-.03.36 0 .43.35.78.78.78.34 0 .63-.22.74-.54.07-.21.13-.42.18-.64.05-.21.08-.43.1-.64.02-.21.03-.42.03-.64 0-5.52-4.48-10-10-10zm-5.5 5c-.83 0-1.5.67-1.5 1.5S5.67 10 6.5 10 8 9.33 8 8.5 7.33 7 6.5 7zm3 0c-.83 0-1.5.67-1.5 1.5S8.67 10 9.5 10s1.5-.67 1.5-1.5S10.33 7 9.5 7zm5 0c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5 1.5-.67 1.5-1.5S15.33 7 14.5 7zm3 0c-.83 0-1.5.67-1.5 1.5s.67 1.5 1.5 1.5S19 9.33 19 8.5 18.33 7 17.5 7z',
}
