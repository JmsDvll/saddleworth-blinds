...
const iconPaths = {
  ...
  locationMarker: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z',
  ...
  // Nature/Environment
  water: 'M12 2c-1.5 4-6 6-6 10a6 6 0 1012 0c0-4-4.5-6-6-10z',
  ...
  // Controls
  slider: 'M21 12a9 9 0 11-18 0 9 9 0 0118 0z M12 8v4m0 0l-3 3m3-3l3 3',
  
  // Arrows
  down: 'M19 9l-7 7-7-7',
  
  // Brands
  google: 'M17.064 17.816A8.97 8.97 0 0021 12c0-.957-.15-1.88-.43-2.745H12v5.19h4.89c-.21 1.125-.843 2.078-1.796 2.717l2.97 2.654zM12 21c2.7 0 4.964-.896 6.62-2.428l-3.23-2.51c-.895.6-2.04.955-3.39.955-2.605 0-4.81-1.76-5.595-4.123l-3.34 2.577A8.997 8.997 0 0012 21z M6.405 12.894c-.2-.6-.314-1.24-.314-1.894 0-.66.114-1.294.314-1.894L3.065 6.53A8.997 8.997 0 003 12c0 1.452.348 2.827.965 4.047l3.34-2.577z M12 5.983c1.467 0 2.785.505 3.823 1.496l2.868-2.868C17.054 3.089 14.697 2 12 2 7.799 2 4.14 4.206 2.065 7.47l3.34 2.577C6.19 7.743 8.395 5.983 12 5.983z',
  
  // Design
  palette: 'M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a4 4 0 00-8 0v4a2 2 0 002 2z'
}
...
Icon.Spinner = ({ size = 'medium', className = '' }) => {
  return (
    <div className={`${iconStyles.sizes[size]} ${className}`}>
