...
// Icon path definitions - NO INLINE STYLES!
const iconPaths = {
  // Navigation
  ...
  // Currency
  pound: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1',
  ...
  // People
  users: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M21 12a3 3 0 11-6 0 3 3 0 016 0z',
  ...
  slider: 'M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4',
...
const iconStyles = {
  ...
  // Colors (using currentColor for flexibility)
  colors: {
    inherit: '',
    white: 'text-white',
    black: 'text-gray-900',
...
// Loading spinner as a special icon
Icon.Spinner = ({ size = 'medium', color = 'inherit', className = '' }) => {
  const classes = [
    iconStyles.sizes[size],
    iconStyles.colors[color],
    'animate-spin',
