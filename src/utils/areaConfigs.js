...
export const areaConfigs = {
  uppermill: {
    name: 'Uppermill',
    heroTitle: 'Premium Blinds in Uppermill',
    heroSubtitle: 'Transform Your Saddleworth Home',
    description: 'Serving the heart of Saddleworth with quality window blinds. From Victorian terraces to modern developments, we understand Uppermill homes.',
    features: [
  ...
  diggle: {
    name: 'Diggle',
    heroTitle: 'Beautiful Blinds in Diggle',
    heroSubtitle: 'Quality Window Solutions',
    description: 'Providing Diggle homes with premium blinds. From countryside cottages to new builds, we have the perfect solution for your windows.',
    features: [
  ...
  delph: {
    name: 'Delph',
    heroTitle: 'Window Blinds in Delph',
    heroSubtitle: 'Local Expertise, Premium Quality',
    description: 'Delph residents trust us for quality blinds. From hilltop homes with stunning views to cosy village cottages, we have you covered.',
    features: [
  ...
  dobcross: {
    name: 'Dobcross',
    heroTitle: 'Dobcross Blind Specialists',
    heroSubtitle: 'Enhancing Village Homes',
    description: 'Quality blinds for Dobcross properties. From the village centre to surrounding hamlets, we provide perfect window solutions.',
    features: [
  ...
  denshaw: {
    name: 'Denshaw',
    heroTitle: 'Premium Blinds in Denshaw',
    heroSubtitle: 'Rural Homes, Modern Solutions',
    description: 'Bringing quality window blinds to Denshaw. From farmhouses to new developments, we understand rural Saddleworth living.',
    features: [
  ...
  greenfield: {
    name: 'Greenfield',
    heroTitle: 'Greenfield Window Blinds',
    heroSubtitle: 'Valley Views, Perfect Privacy',
    description: 'Exceptional blinds for Greenfield homes. From traditional terraces to modern eco-homes, we have the expertise you need.',
    features: [
  ...
  grotton: {
    name: 'Grotton',
    heroTitle: 'Quality Blinds in Grotton',
    heroSubtitle: 'Local Service, Premium Products',
    description: 'Trusted by Grotton homeowners for premium blinds. From cottage windows to modern extensions, we deliver perfect solutions.',
    features: [
  ...
  lydgate: {
    name: 'Lydgate',
    heroTitle: 'Lydgate Blind Specialists',
    heroSubtitle: 'Hillside Homes, Valley Views',
    description: 'Premium window blinds for Lydgate properties. From hillside homes to village cottages, we provide solutions that work.',
    features: [
  ...
  springhead: {
    name: 'Springhead',
    heroTitle: 'Springhead Window Blinds',
    heroSubtitle: 'Village Charm, Modern Comfort',
    description: 'Quality blinds for Springhead homes. From traditional stone cottages to modern properties, we enhance every window.',
    features: [
  ...
  grasscroft: {
    name: 'Grasscroft',
    heroTitle: 'Grasscroft Blind Services',
    heroSubtitle: 'Quality Windows, Quality Service',
    description: 'Bringing premium blinds to Grasscroft. From family homes to retirement properties, we provide perfect window solutions.',
    features: [
  ...
  lees: {
    name: 'Lees',
    heroTitle: 'Window Blinds in Lees',
    heroSubtitle: 'Transform Your Home Today',
    description: 'Lees residents choose us for quality blinds. From terraced houses to modern estates, we have the perfect solution.',
    features: [
  ...
  friezland: {
    name: 'Friezland',
    heroTitle: 'Friezland Window Solutions',
    heroSubtitle: 'Rural Beauty, Modern Blinds',
    description: 'Premium blinds for Friezland properties. From countryside homes to village cottages, we understand rural window needs.',
    features: [
