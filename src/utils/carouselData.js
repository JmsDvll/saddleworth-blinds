// Carousel data for all products
export const carouselData = {
  ...
  'venetian-blinds': [
    {
      image: 'venetian-starwood-1600.jpg',
  ...
  'vision-blinds': [
    {
      image: 'vision-capri-concrete-1600.jpg',
  ...
  'vertical-blinds': [
    {
      image: 'vertical-savanna-zebra-1600.jpg',
  ...
  'perfect-fit-blinds': [
    {
      image: 'perfectfit-monet-flower-1600.jpg',
      alt: 'Monet Flower perfect fit blind',
      title: 'Monet Flower',
  ...
  'shutters': [
    {
      image: 'shutters-cotton-89mm-1600.jpg',
      alt: 'Cotton white plantation shutters',
